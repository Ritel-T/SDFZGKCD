...
live2d_settings['modelTexturesId']      = 21;           // 默认材质 ID，可在 F12 控制台找到
...
live2d_settings['waifuTipsSize']        = '224x84';     // 提示框大小，例如 '250x70', '570x150'
live2d_settings['waifuFontSize']        = '16px';       // 提示框字体，例如 '12px', '30px'
live2d_settings['waifuToolFont']        = '24px';       // 工具栏字体，例如 '14px', '36px'
live2d_settings['waifuToolLine']        = '150%';       // 工具栏行高，例如 '20px', '36px'
live2d_settings['waifuToolTop']         = '0'           // 工具栏顶部边距，例如 '0px', '-60px'
live2d_settings['waifuMinWidth']        = 'disable';    // 页面小于 指定宽度 隐藏看板娘，例如 'disable'(禁用), '768px'
live2d_settings['waifuEdgeSide']        = 'left:1260';  // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
function initModel(waifuPath, type) {
    ...
    if (!live2d_settings.canCloseLive2d) $('.waifu-tool .fui-close').hide();
